  ...
  <Layout title="mba">
    ...
    <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900">
      <div className="text-center space-y-10">
        <h3 className="font-light text-xl uppercase tracking-wider">
          MBA MAGIC COMING SOON!
        </h3>
        <h1 className="text-7xl lg:text-9xl font-extrabold mbalogo">mba.</h1>
        {/* <h1 className="text-7xl lg:text-8xl font-bold ">my business app.</h1> */}
    ...
    <div className="absolute bottom-5">
      <ul className="flex space-x-3">
        ...
        <li>
          <Link href="https://twitter.com/downloadmba">
            <a className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 transition ease-in-out duration-500 hover:bg-red-500 hover:text-white hover:shadow-lg">
              <svg
                className="w-6 h-6"
                fill="currentColor"
        ...
        <li>
          <Link href="https://linkedin.com/company/downloadmba/">
            <a className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 transition ease-in-out duration-500 hover:bg-red-500 hover:text-white hover:shadow-lg">
              <svg
                className="w-6 h-6"
                fill="currentColor"
        ...
        <li>
          <Link href="https://mybusinessapp.gitbook.io/product-docs/">
            <a className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 transition ease-in-out duration-500 hover:bg-red-500 hover:text-white hover:shadow-lg">
              <svg
                className="w-6 h-6"
                fill="currentColor"
        ...
        <li>
          <Link href="mailto:wearehere@mybusiness.app">
            <a className="flex items-center justify-center w-10 h-10 rounded-full bg-gray-50 transition ease-in-out duration-500 hover:bg-red-500 hover:text-white hover:shadow-lg">
              <svg
                className="w-6 h-6"
                fill="currentColor"
